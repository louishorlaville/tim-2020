...
<article id="chemeninment-contenu-principal">
  <table id="cheminement-table">
    ...
    <tr id="session-row-2" class="session-row">
      <th class="class-cell"><div class="class-tag color-2"> JEU</div></th>
    </tr>
    <tr class="separator"></tr>
    <tr id="session-row-3" class="session-row">
      <th class="class-cell"></th>
    </tr>
    <tr class="separator"></tr>
    <tr id="session-row-4" class="session-row">
      <th class="class-cell"></th>
    </tr>
    <tr class="separator"></tr>
    <tr id="session-row-5" class="session-row">
      <th class="class-cell"></th>
    </tr>
    <tr class="separator"></tr>
    <tr id="session-row-6" class="session-row">
      <th class="class-cell"></th>
    </tr>
  </table>

  <table id="cheminement-table-mobile">
  </table>
</aticle>
